<template>
	<div id="section2" class="h-screen relative flex justify-center mb-32">
		<div class="modelContainer overflow-hidden">
			...
			<p class=" text-black text-sm absolute laptopTextBg">16" laptop Pro i black med X3 Pro eller X3 Max</p>
			<div class="sizeSwich">
