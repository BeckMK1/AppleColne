        ...
        <div class="accordionBox bg-zinc-200 p-16 rounded-3xl">
            <div class="flex md:flex-row flex-col justify-between">
                ...
                <div class="md:w-1/2 w-full accordionImageContainer">
                        <img class="accordionImage" :class="accordion.name == currentAccordion ? 'accordionImageShow': 'accordionImageHide' "  v-show="accordion.name == currentAccordion" v-for='accordion in accordions' :src="accordion.image" alt="">
                </div>
            </div>
        </div>
	</div>
